...
import mx.tec.web.lab.manger.ProductManager;
...
public class Controller {
	 ...
	 */
	@GetMapping("/products")
	public ResponseEntity<List<Registro>> getProducts() {
	...
	public ResponseEntit<ProductVO> deleteProduct(@PathVariable(value = "id") long id) {
		ResponseEntity<ProductVO> responseEntity = new ResponseEntity<>(HttpStatus.NO_CONTENT);
		Optional<ProductVO> product = productManager.getProduct(id);
